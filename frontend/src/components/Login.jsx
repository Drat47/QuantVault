  ...
  return (
    <div className="w-full max-w-md mx-auto mt-12 animate-fade-in">
      <div className="glass-panel gradient-border-gold rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-3xl -z-10 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-emerald-500/10 rounded-full blur-3xl -z-10 pointer-events-none"></div>

        {/* Brand Header */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-amber-500 shadow-lg shadow-emerald-500/20 mb-3">
          ...
          <p className="text-slate-400 text-sm mt-1.5">Sign in to manage your asset investments</p>
        </div>
